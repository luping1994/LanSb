 ...
 */
public class SettingNew_Activity extends BasedActivity implements Switch.OnSwitchChangedListener, View.OnClickListener {
    ...
    public void getData(final int id) {
        RetrofitHelper.getApi3().getSixSensorConfig(String.valueOf(id))

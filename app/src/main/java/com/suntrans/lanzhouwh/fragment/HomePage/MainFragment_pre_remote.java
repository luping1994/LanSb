...
public class MainFragment_pre_remote extends BasedFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return createSuccessView();  //  拿到当前viewPager 添加这个framelayout
    }
...
//                });
    ...
    public static MainFragment_pre_remote newInstance() {

        return new MainFragment_pre_remote();
    }

...
public class HumFragment extends BasedFragment {
...
//                    Value = Value + "(" + Evaluate + ")";
    ...
    public void setData(SixSensorInfo info){
        ...
        try {
            ...
            datas.get(1).put("Value",info.wendu+"℃");
            datas.get(2).put("Value",info.shidu+"%Rh");
            datas.get(3).put("Value",info.daqiya+"KPa");
            datas.get(4).put("Value",info.guanxiqd);
            datas.get(5).put("Value",info.renyuanxx);

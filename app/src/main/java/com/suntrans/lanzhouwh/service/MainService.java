...
//
    ...
    public int sixSensorPort=8997;    //服务器端口
//     public String sixSensorIp="192.168.1.7";     //服务器IP
//    public int sixSensorPort=8000;    //服务器端口
...
//        sixSensorPort= Integer.valueOf(sharedPreferences.getString("sixSensorPort", "8086"));
        ...
        LogUtil.i("Intenet", "sixSensorport==>" + sixSensorPort);
    ...
    public void onCreate() {
        ...
        sixSensorIp = App.getSharedPreferences().getString("sixSensorIp","61.235.65.160");
        sixSensorPort = App.getSharedPreferences().getInt("sixSensorPort",8997);
//

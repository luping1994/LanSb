...
public class AttrFactory {
    ...
    public static final String BB_ACTIVITABCOLOR = "bb_activeTabColor";
    public static final String COLOR_FILTER = "ColorFilter1";
...
//            Log.i(TAG, "create:FabButtonAttr");
        } else if (attrName.equals("bb_activeTabColor")){
//            Log.e(TAG, "create:BottombarViewAttr");
            mSkinAttr = new BottombarViewAttr();
        }else if (attrName.equals("ColorFilter1")){
//            Log.i(TAG, "attrName:ddddd" + attrName);
            mSkinAttr = new ImageViewAttr();
        }
...
//        if (mSkinAttr instanceof ImageViewAttr){
//            System.out.println(mSkinAttr.attrName +"  ");
//            System.out.println(mSkinAttr.attrValueRefId +"  ");
//            System.out.println(mSkinAttr.attrValueRefName +"  ");
//            System.out.println(mSkinAttr.attrValueTypeName +"  ");
//        }
        return mSkinAttr;
    }
    ...
    public static boolean isSupportedAttr(String attrName) {
        ...
        if (BB_ACTIVITABCOLOR.equals(attrName)){

            return true;
        }
        if (COLOR_FILTER.equals(attrName)){
            return true;
        }

...
public class SkinManager implements ISkinLoader {
    ...
    public int getColorPrimaryDark() {
        if (mResources != null) {
            ...
            int identify = resources.getIdentifier("colorPrimaryDark", "color", context.getPackageName());
...
//            System.out.println("皮肤管理者移除");
            mSkinObservers.remove(observer);
//            for (int i = 0;i<mSkinObservers.size();i++) {
//                System.out.println("包含的activity有："+mSkinObservers.get(i).getClass().getSimpleName());
//            }
        }
    }
    ...
    public synchronized void load(String skinPackagePath, final ILoaderListener callback) {
        ...
        new AsyncTask<String, Void, Resources>() {
            ...
            protected Resources doInBackground(String... params) {
                try {
                    ///data/data/com.suntrans.lanzhouwh/skin/skin_black.skin
                    if (params.length == 1) {
